              ...
              <div class='bg-white u-pos-relative l-z-index-100 u-cf'>
                  <div class="content-nav-section" data-short-name="About Us">
                      ...
                      <div class="rtf mt-4 mb-2 l-contain">
                         First Citizens bank is dedicated to provide exceptional financial service to its members. Become a member today!                        </div>
                  </div>
                  ...
                  <div id="getstarted">
                      <div class="quick-bar__wrap l-contain">
                          ...
                          <div class='quick-bar'>
                              ...
                              <a class='quick-bar__item' href='mailto:support@fccub.com'>
                      ...
                      <section class="join-cta join-cta--secondary join-cta--ms" aria-label="Join First">
                          <div class="join-cta-content l-contain u-align-center">
                              ...
                              <a href="#" onClick="alert('Unable to determine your location. Please contact support')" class="join-cta__link"
                                  title="Search tool to find First Branches and ATMs.">Find a Branch</a>
                          </div>
                      </section>
                  </div>
              </div>
