                  ...
                  <div class="l-bg-gray padding-content" id="faqs">
                      <section class="faq l-contain js-faq" aria-label="FAQ">
                          ...
                          <div class="faq__inner l-bg-white">
                                                              <div class="faq__item">
                                  <a class="faq__question js-faq-open" href="#">Is the company registered and regulated</a>
                                  <div class="faq__answer rtf">
                                     <p><font color="#011f4c" face="Open Sans, sans-serif"><span style="font-size: 16px;">Yes, our Company is totally a legal platform licensed by the Securities and Exchange Commission&nbsp;to carry out financial activities in over 105 countries?</span></font><br></p>                                    </div>
                              </div>
                                                              <div class="faq__item">
                                  <a class="faq__question js-faq-open" href="#">What is the field of activity of the company?</a>
                                  <div class="faq__answer rtf">
                                     <p>The company is engaged in cryptocurrency and Forex trading. Our staff of highly qualified traders and financial experts shows high profit rates from year to year. The company's priorities are access to international markets and long-term cooperation with investors.<br></p>                                    </div>
                              </div>
                                                              <div class="faq__item">
                                  <a class="faq__question js-faq-open" href="#">Who can be a Customer of Givens Hall Bank?</a>
                                  <div class="faq__answer rtf">
                                     <p>Everyone can be a Customer of Givens Hall Bank, but he\she must be not less 18 years old.<br></p>                                    </div>
                              </div>
                                                              <div class="faq__item">
                                  <a class="faq__question js-faq-open" href="#">How can I become an investor in the company?</a>
                                  <div class="faq__answer rtf">
                                     <p>You may become a client of the company and it is totally free of charge. All you need is to sign up and fill all required fields. It takes less than 2 minutes to complete sign up.<br></p>                                    </div>
                              </div>
                                                              <div class="faq__item">
                                  <a class="faq__question js-faq-open" href="#">How reliable is the company in terms of security and personal data?</a>
                                  <div class="faq__answer rtf">
                                     <p>We pay great attention to security and privacy. All information on our website is protected by SSL. We do not divulge any personal data of our customers to third parties. Your participation is strictly confidential.<br></p>                                    </div>
                              </div>
                                                              <div class="faq__item">
                                  <a class="faq__question js-faq-open" href="#">Is there a KYC verification process?</a>
                                  <div class="faq__answer rtf">
                                     <p>Yes, we do require verification documents confirming the identity, address or origin of account owner.<br></p>                                    </div>
                              </div>
