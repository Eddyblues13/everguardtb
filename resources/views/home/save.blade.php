                  ...
                  <section class='sub-hero hero--image js-hero--image' aria-label="Hero Area">
                      ...
                      <div class='sub-hero-content l-contain'>
                          <div class='sub-hero-content-inner'>
                              ...
                              <p class='sub-hero__teaser p'>First Citizens Bank is a highly ranked global financial institution</p>
                          </div>
                      </div>
                  </section>
              </div>
                  ...
                  <section class="join-cta join-cta--primary" aria-label="Join First">
                      <div class="join-cta-content l-contain u-align-center">
                          <h2 class="join-cta__title ">Ready to speak with a representative about a First savings
                              account? </h2>
                          <a href="mailto:support@fccub.com" class="join-cta__link" rel="noopener noreferrer"
